...
PHRASES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "overdue": "Agentforce overdue casework",
        "late_cases": "cases are past their target review date",
        "at_risk_in_late": "of exposure sitting in late cases",
        "never_picked_up": "have never been picked up",
        "oldest": "the oldest is",
        "days_late": "days late",
        "rota": "Agentforce field rota",
        "auditors": "auditors",
        "busiest": "Busiest round",
        "each_agency_one_auditor": "Every agency stays with one auditor, because splitting one pays for the same journey twice",
        "dossier": "Agentforce agency dossier",
        "scoreboard": "Agentforce field scoreboard",
        "visits_recorded": "site visits recorded",
        "too_few_to_score": "too few visits to report a rate yet",
        "contract": (
    ...
    "hi": {
        ...
        "overdue": "एजेंटफोर्स विलंबित प्रकरण",
        "late_cases": "प्रकरण अपनी लक्षित समीक्षा तिथि पार कर चुके हैं",
        "at_risk_in_late": "जोखिम राशि विलंबित प्रकरणों में अटकी है",
        "never_picked_up": "अब तक किसी ने नहीं उठाए",
        "oldest": "सबसे पुराना",
        "days_late": "दिन विलंबित",
        "rota": "एजेंटफोर्स क्षेत्र ड्यूटी सूची",
        "auditors": "लेखा परीक्षक",
        "busiest": "सर्वाधिक व्यस्त चक्र",
        "each_agency_one_auditor": "प्रत्येक एजेंसी एक ही लेखा परीक्षक के पास रहती है, क्योंकि उसे बाँटने पर वही यात्रा दो बार चुकानी पड़ती है",
        "dossier": "एजेंटफोर्स एजेंसी विवरणिका",
        "scoreboard": "एजेंटफोर्स क्षेत्र परिणाम पट",
        "visits_recorded": "स्थल निरीक्षण दर्ज",
        "too_few_to_score": "दर बताने के लिए निरीक्षण अभी बहुत कम हैं",
        "contract": (
    ...
    "bn": {
        ...
        "overdue": "এজেন্টফোর্স বিলম্বিত মামলা",
        "late_cases": "মামলা তাদের নির্ধারিত পর্যালোচনার তারিখ পেরিয়ে গেছে",
        "at_risk_in_late": "ঝুঁকির অর্থ বিলম্বিত মামলায় আটকে আছে",
        "never_picked_up": "এখনও কেউ হাতে নেয়নি",
        "oldest": "সবচেয়ে পুরনোটি",
        "days_late": "দিন বিলম্বিত",
        "rota": "এজেন্টফোর্স মাঠ কর্মসূচি",
        "auditors": "নিরীক্ষক",
        "busiest": "সবচেয়ে ব্যস্ত পালা",
        "each_agency_one_auditor": "প্রতিটি সংস্থা একজন নিরীক্ষকের কাছেই থাকে, কারণ ভাগ করলে একই যাত্রার খরচ দুবার দিতে হয়",
        "dossier": "এজেন্টফোর্স সংস্থা নথি",
        "scoreboard": "এজেন্টফোর্স মাঠ ফলাফল",
        "visits_recorded": "সরেজমিন পরিদর্শন নথিভুক্ত",
        "too_few_to_score": "হার জানাতে পরিদর্শনের সংখ্যা এখনও খুব কম",
        "contract": (
    ...
    "ta": {
        ...
        "overdue": "ஏஜென்ட்ஃபோர்ஸ் தாமதமான வழக்குகள்",
        "late_cases": "வழக்குகள் நிர்ணயித்த மறுஆய்வு தேதியைக் கடந்துவிட்டன",
        "at_risk_in_late": "இடர் தொகை தாமதமான வழக்குகளில் நிற்கிறது",
        "never_picked_up": "இன்னும் யாரும் கையில் எடுக்கவில்லை",
        "oldest": "மிகப் பழையது",
        "days_late": "நாட்கள் தாமதம்",
        "rota": "ஏஜென்ட்ஃபோர்ஸ் கள பணிப் பட்டியல்",
        "auditors": "தணிக்கையாளர்கள்",
        "busiest": "அதிக பணிச்சுமை கொண்ட சுற்று",
        "each_agency_one_auditor": "ஒவ்வொரு நிறுவனமும் ஒரே தணிக்கையாளரிடம் இருக்கும், ஏனெனில் பிரித்தால் ஒரே பயணத்திற்கு இரு முறை செலவாகும்",
        "dossier": "ஏஜென்ட்ஃபோர்ஸ் நிறுவனக் குறிப்பேடு",
        "scoreboard": "ஏஜென்ட்ஃபோர்ஸ் கள மதிப்பீட்டுப் பலகை",
        "visits_recorded": "நேரடி ஆய்வுகள் பதிவு",
        "too_few_to_score": "விகிதம் சொல்ல ஆய்வுகள் இன்னும் மிகக் குறைவு",
        "contract": (
    ...
    "te": {
        ...
        "overdue": "ఏజెంట్‌ఫోర్స్ ఆలస్యమైన కేసులు",
        "late_cases": "కేసులు నిర్ణీత సమీక్ష తేదీని దాటాయి",
        "at_risk_in_late": "ప్రమాద మొత్తం ఆలస్యమైన కేసుల్లో నిలిచి ఉంది",
        "never_picked_up": "ఇంకా ఎవరూ చేపట్టలేదు",
        "oldest": "అత్యంత పాతది",
        "days_late": "రోజులు ఆలస్యం",
        "rota": "ఏజెంట్‌ఫోర్స్ క్షేత్ర విధుల పట్టిక",
        "auditors": "ఆడిటర్లు",
        "busiest": "అత్యధిక పని ఉన్న రౌండ్",
        "each_agency_one_auditor": "ప్రతి సంస్థ ఒకే ఆడిటర్ వద్దే ఉంటుంది, ఎందుకంటే విభజిస్తే ఒకే ప్రయాణానికి రెండుసార్లు ఖర్చవుతుంది",
        "dossier": "ఏజెంట్‌ఫోర్స్ సంస్థ సమాచార పత్రం",
        "scoreboard": "ఏజెంట్‌ఫోర్స్ క్షేత్ర ఫలితాల పట్టిక",
        "visits_recorded": "క్షేత్ర తనిఖీలు నమోదు",
        "too_few_to_score": "రేటు చెప్పడానికి తనిఖీలు ఇంకా చాలా తక్కువ",
        "contract": (
    ...
    "mr": {
        ...
        "overdue": "एजंटफोर्स विलंबित प्रकरणे",
        "late_cases": "प्रकरणे त्यांची नियोजित पुनरावलोकन तारीख ओलांडून गेली आहेत",
        "at_risk_in_late": "जोखमीची रक्कम विलंबित प्रकरणांत अडकली आहे",
        "never_picked_up": "अद्याप कोणीही हाती घेतलेली नाहीत",
        "oldest": "सर्वात जुने",
        "days_late": "दिवस विलंब",
        "rota": "एजंटफोर्स क्षेत्र कार्यसूची",
        "auditors": "लेखापरीक्षक",
        "busiest": "सर्वाधिक व्यस्त फेरी",
        "each_agency_one_auditor": "प्रत्येक संस्था एकाच लेखापरीक्षकाकडे राहते, कारण विभागणी केल्यास एकाच प्रवासाचा खर्च दोनदा होतो",
        "dossier": "एजंटफोर्स संस्था माहितीपत्र",
        "scoreboard": "एजंटफोर्स क्षेत्र निकाल फलक",
        "visits_recorded": "स्थळ पाहणी नोंदवली",
        "too_few_to_score": "दर सांगण्यासाठी पाहण्या अजून फार कमी आहेत",
        "contract": (
    ...
    "gu": {
        ...
        "overdue": "એજન્ટફોર્સ વિલંબિત કેસ",
        "late_cases": "કેસ તેમની નિર્ધારિત સમીક્ષા તારીખ વટાવી ગયા છે",
        "at_risk_in_late": "જોખમની રકમ વિલંબિત કેસોમાં અટવાયેલી છે",
        "never_picked_up": "હજી સુધી કોઈએ હાથમાં લીધા નથી",
        "oldest": "સૌથી જૂનો",
        "days_late": "દિવસ વિલંબ",
        "rota": "એજન્ટફોર્સ ક્ષેત્ર કાર્યસૂચિ",
        "auditors": "ઓડિટર",
        "busiest": "સૌથી વ્યસ્ત ફેરો",
        "each_agency_one_auditor": "દરેક સંસ્થા એક જ ઓડિટર પાસે રહે છે, કારણ કે વહેંચવાથી એક જ મુસાફરીનો ખર્ચ બે વાર થાય છે",
        "dossier": "એજન્ટફોર્સ સંસ્થા દસ્તાવેજ",
        "scoreboard": "એજન્ટફોર્સ ક્ષેત્ર પરિણામ પટ",
        "visits_recorded": "સ્થળ મુલાકાત નોંધાઈ",
        "too_few_to_score": "દર જણાવવા માટે મુલાકાતો હજી ઘણી ઓછી છે",
        "contract": (
    ...
    "kn": {
        ...
        "overdue": "ಏಜೆಂಟ್‌ಫೋರ್ಸ್ ವಿಳಂಬಿತ ಪ್ರಕರಣಗಳು",
        "late_cases": "ಪ್ರಕರಣಗಳು ನಿಗದಿತ ಪರಿಶೀಲನಾ ದಿನಾಂಕವನ್ನು ಮೀರಿವೆ",
        "at_risk_in_late": "ಅಪಾಯದ ಮೊತ್ತ ವಿಳಂಬಿತ ಪ್ರಕರಣಗಳಲ್ಲಿ ನಿಂತಿದೆ",
        "never_picked_up": "ಇನ್ನೂ ಯಾರೂ ಕೈಗೆತ್ತಿಕೊಂಡಿಲ್ಲ",
        "oldest": "ಅತ್ಯಂತ ಹಳೆಯದು",
        "days_late": "ದಿನ ವಿಳಂಬ",
        "rota": "ಏಜೆಂಟ್‌ಫೋರ್ಸ್ ಕ್ಷೇತ್ರ ಕರ್ತವ್ಯ ಪಟ್ಟಿ",
        "auditors": "ಲೆಕ್ಕಪರಿಶೋಧಕರು",
        "busiest": "ಅತಿ ಹೆಚ್ಚು ಕೆಲಸದ ಸುತ್ತು",
        "each_agency_one_auditor": "ಪ್ರತಿ ಸಂಸ್ಥೆ ಒಬ್ಬ ಲೆಕ್ಕಪರಿಶೋಧಕರ ಬಳಿಯೇ ಇರುತ್ತದೆ, ಏಕೆಂದರೆ ಹಂಚಿದರೆ ಒಂದೇ ಪ್ರಯಾಣಕ್ಕೆ ಎರಡು ಬಾರಿ ವೆಚ್ಚವಾಗುತ್ತದೆ",
        "dossier": "ಏಜೆಂಟ್‌ಫೋರ್ಸ್ ಸಂಸ್ಥೆ ಕಡತ",
        "scoreboard": "ಏಜೆಂಟ್‌ಫೋರ್ಸ್ ಕ್ಷೇತ್ರ ಫಲಿತಾಂಶ ಫಲಕ",
        "visits_recorded": "ಸ್ಥಳ ಭೇಟಿಗಳು ದಾಖಲಾಗಿವೆ",
        "too_few_to_score": "ದರ ಹೇಳಲು ಭೇಟಿಗಳು ಇನ್ನೂ ತೀರಾ ಕಡಿಮೆ",
        "contract": (
    ...
    "ml": {
        ...
        "overdue": "ഏജന്റ്ഫോഴ്സ് വൈകിയ കേസുകൾ",
        "late_cases": "കേസുകൾ നിശ്ചയിച്ച പുനഃപരിശോധന തീയതി കടന്നിരിക്കുന്നു",
        "at_risk_in_late": "അപകടസാധ്യതയുള്ള തുക വൈകിയ കേസുകളിൽ കുടുങ്ങിക്കിടക്കുന്നു",
        "never_picked_up": "ഇതുവരെ ആരും ഏറ്റെടുത്തിട്ടില്ല",
        "oldest": "ഏറ്റവും പഴയത്",
        "days_late": "ദിവസം വൈകി",
        "rota": "ഏജന്റ്ഫോഴ്സ് ഫീൽഡ് ഡ്യൂട്ടി പട്ടിക",
        "auditors": "ഓഡിറ്റർമാർ",
        "busiest": "ഏറ്റവും തിരക്കുള്ള ഘട്ടം",
        "each_agency_one_auditor": "ഓരോ ഏജൻസിയും ഒരേ ഓഡിറ്ററുടെ പക്കൽ തന്നെ നിൽക്കുന്നു, കാരണം വിഭജിച്ചാൽ ഒരേ യാത്രയ്ക്ക് രണ്ടു തവണ ചെലവാകും",
        "dossier": "ഏജന്റ്ഫോഴ്സ് ഏജൻസി രേഖ",
        "scoreboard": "ഏജന്റ്ഫോഴ്സ് ഫീൽഡ് ഫലപ്പലക",
        "visits_recorded": "സ്ഥല പരിശോധനകൾ രേഖപ്പെടുത്തി",
        "too_few_to_score": "നിരക്ക് പറയാൻ പരിശോധനകൾ ഇനിയും വളരെ കുറവാണ്",
        "contract": (
    ...
    "pa": {
        ...
        "overdue": "ਏਜੰਟਫੋਰਸ ਦੇਰੀ ਵਾਲੇ ਕੇਸ",
        "late_cases": "ਕੇਸ ਆਪਣੀ ਨਿਯਤ ਸਮੀਖਿਆ ਮਿਤੀ ਲੰਘ ਚੁੱਕੇ ਹਨ",
        "at_risk_in_late": "ਜੋਖਮ ਵਾਲੀ ਰਕਮ ਦੇਰੀ ਵਾਲੇ ਕੇਸਾਂ ਵਿੱਚ ਫਸੀ ਹੋਈ ਹੈ",
        "never_picked_up": "ਹੁਣ ਤੱਕ ਕਿਸੇ ਨੇ ਹੱਥ ਵਿੱਚ ਨਹੀਂ ਲਏ",
        "oldest": "ਸਭ ਤੋਂ ਪੁਰਾਣਾ",
        "days_late": "ਦਿਨ ਦੇਰੀ",
        "rota": "ਏਜੰਟਫੋਰਸ ਫੀਲਡ ਡਿਊਟੀ ਸੂਚੀ",
        "auditors": "ਆਡੀਟਰ",
        "busiest": "ਸਭ ਤੋਂ ਰੁੱਝਿਆ ਗੇੜ",
        "each_agency_one_auditor": "ਹਰ ਸੰਸਥਾ ਇੱਕੋ ਆਡੀਟਰ ਕੋਲ ਰਹਿੰਦੀ ਹੈ, ਕਿਉਂਕਿ ਵੰਡਣ ਨਾਲ ਇੱਕੋ ਸਫ਼ਰ ਦਾ ਖਰਚ ਦੋ ਵਾਰ ਪੈਂਦਾ ਹੈ",
        "dossier": "ਏਜੰਟਫੋਰਸ ਸੰਸਥਾ ਦਸਤਾਵੇਜ਼",
        "scoreboard": "ਏਜੰਟਫੋਰਸ ਫੀਲਡ ਨਤੀਜਾ ਫੱਟੀ",
        "visits_recorded": "ਸਾਈਟ ਦੌਰੇ ਦਰਜ",
        "too_few_to_score": "ਦਰ ਦੱਸਣ ਲਈ ਦੌਰੇ ਹਾਲੇ ਬਹੁਤ ਘੱਟ ਹਨ",
        "contract": (
